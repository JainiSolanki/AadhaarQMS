...
const OperatorProfile = () => {
    ...
    const profileFields = [
        ...
        { icon: Shield, label: 'Role', value: 'Operator', color: '#10b981', bg: 'rgba(16,185,129,0.1)' },
        { icon: Hash, label: 'Counter ID', value: user?.counterId || '—', color: '#f59e0b', bg: 'rgba(245,158,11,0.1)' },
        { icon: Calendar, label: 'Member Since', value: user?.createdAt ? formatDate(user.createdAt) : 'N/A', color: '#8b5cf6', bg: 'rgba(139,92,246,0.1)' },
    ];
    ...
    return (
        <DashboardLayout>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '0.5rem 0' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                background: 'radial-gradient(circle at 25% 50%, rgba(255,255,255,0.1) 0%, transparent 50%), radial-gradient(circle at 75% 50%, rgba(255,255,255,0.08) 0%, transparent 50%)',
                            }} />
                        </div>
                        ...
                        <div style={{ padding: '0 2rem 2rem', position: 'relative' }}>
                            ...
                            <div style={{
                                ...
                                boxShadow: '0 8px 32px rgba(16,185,129,0.35), 0 0 0 4px var(--bg-surface)',
                            ...
                            <div style={{
                                ...
                                {[
                                    { icon: Hash, label: 'Counter', value: user?.counterId || '—', color: '#f59e0b', bg: 'rgba(245,158,11,0.1)' },
                                    { icon: Shield, label: 'Role', value: 'Operator', color: '#10b981', bg: 'rgba(16,185,129,0.1)' },
                                    { icon: KeyRound, label: 'Status', value: 'Active', color: '#6366f1', bg: 'rgba(99,102,241,0.1)' },
                                ].map((stat) => (
                                    <div
                                        key={stat.label}
                                        style={{
                ...
                {/* ── Two columns: Account Info + Security ── */}
